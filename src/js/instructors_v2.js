...
export async function fetchInstructors(
  ...
  if (firstname_match)
    api_request += `&firstname_match=${encodeURIComponent(firstname_match)}`;
  if (initial_match)
    api_request += `&initial_match=${encodeURIComponent(initial_match)}`;
  if (lastname_match)
    api_request += `&lastname_match=${encodeURIComponent(lastname_match)}`;
